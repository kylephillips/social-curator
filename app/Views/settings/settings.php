<div class="wrap">
	...
	<h2 class="nav-tab-wrapper">
		...
		<a class="nav-tab <?php if ( $tab == 'bulk-import' ) echo 'nav-tab-active'; ?>" href="options-general.php?page=social-curator-settings&amp;tab=bulk-import"><?php _e('Bulk Import', 'socialcurator'); ?></a>
		<a class="nav-tab <?php if ( $tab == 'logs' ) echo 'nav-tab-active'; ?>" href="options-general.php?page=social-curator-settings&amp;tab=logs"><?php _e('Logs', 'socialcurator'); ?></a>
