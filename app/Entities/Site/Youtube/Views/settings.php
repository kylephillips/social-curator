...
<div class="social-curator-site-settings-instructions">
	<p><?php _e('To connect a YouTube account, first create an application from the Google Developers Console. Once the application has been created, you must create a public API Key.', 'socialcurator') . '</p>'; ?></p>
